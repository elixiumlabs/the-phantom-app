      ...
      <main className="relative">
        ...
        <div className="relative pt-32 pb-32 px-6">
          ...
          <div 
            ...
            style={{
              backgroundImage: 'url(https://uqkeuojzrnxdyefmyuwz.supabase.co/storage/v1/object/public/phantom-assets/phantom-features-hero.jpeg)',
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div 
                  ...
                  style={{ backgroundImage: 'url(https://uqkeuojzrnxdyefmyuwz.supabase.co/storage/v1/object/public/phantom-assets/phantom-how-it-works.jpeg)' }}
                />
